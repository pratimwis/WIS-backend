...
<body class="bg-gray-100 min-h-screen flex">
  <!-- Sidebar -->
  <aside class="w-60 bg-white text-black flex flex-col fixed h-full z-10 shadow-xl rounded-2xl">
    <!-- Logo -->
    <div class=" border-b border-blue-700 flex flex-col space-x-0.5 items-center text-left">
      <img src="http://103.211.218.245/assets/img/wis_logo.png" alt="Wis Logo" class="h-24 w-auto">
  ...
  <div class="flex-1 ml-72 p-6">
    ...
    <header class="sticky top-0 bg-white shadow-sm rounded-lg p-4 mb-6 flex justify-between items-center z-10">
      <div class="flex items-center space-x-3">
        <img src="http://103.211.218.245/assets/img/wis_logo.png" alt="Wis Logo" class="h-8 w-auto">
